...
<div x-data="{ search: '' }">
    ...
    <div x-show="!Object.values({{ Js::from($tableData) }}).some(t => t.name.toLowerCase().includes(search.toLowerCase())) && search !== ''" class="text-center py-12" style="display: none;">
        ...
        <p class="text-gray-400 text-lg">No se encontraron tablas que coincidan con "<span class="text-white font-bold" x-text="search"></span>".</p>
    </div>
</div>
@endsection
